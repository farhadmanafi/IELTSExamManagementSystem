// Class definition
var UpdateCeoInformationQueryFacadeFromControls = function () {
	// Private functions
	var _initUpdateContactsInformation = function () {
		FormValidation.formValidation(
			document.getElementById('_UpdateCeoInformationQueryFacadeFrom'),
			{
				fields: {
					FirstName: {
						validators: {
...
jQuery(document).ready(function () {
	UpdateCeoInformationQueryFacadeFromControls.init();
});
