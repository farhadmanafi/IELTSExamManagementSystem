var DT_OnlinePlacementUserScoreList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_OnlinePlacementUserScoreList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_OnlinePlacementUserScoreList').data("url"),
                type: 'POST'
            },
            columns: [
                { "className": "dt-center", "data": "placementExamTitle", "autowidth": true },
                { "className": "dt-center", "data": "userName", "autowidth": true },
                { "className": "dt-center", "data": "levelScoreName", "autowidth": true },
                { "className": "dt-center", "data": "examDate_Persian", "autowidth": true },
                {
                    "data": "isActive",
                    "className": "dt-center",
                    "orderable": false,
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-info font-weight-bold mr-2"' +
                                'href="/OnlinePlacement/OnlinePlacementCustomerScoreDetail?Id=' + row.id + '" >Show Details</a>';
                    }
                },
            ],
            columnDefs: [{
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_OnlinePlacementUserScoreList')) {
        DT_OnlinePlacementUserScoreList.init();
    }
});
