var DT_CustomerIeltsExam = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_CustomerIeltsExam').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_CustomerIeltsExam').data("url"),
                type: 'POST'
            },
            columns: [
                ...
                {
                    "data": "ieltsExamParticipantsStatusId",
                    "className": "dt-center",
                    "orderable": false,
                    render: function (data, type, row) {
                        if (row.ieltsExamParticipantsStatusId == "7f616320-e394-4e8d-8013-453f238f7afd") { //true
                            //return '<input id="' + row.id + '" type="checkbox" checked="checked" name="isActive">';
                            return '<i class="fas fa-check fa-fw" style="color: green;"></i>';
                        }
                        else if (row.ieltsExamParticipantsStatusId == "d0acc476-435a-44f1-9050-09bf748570ff") { //false
                    ...
                    render: function (data, type, row) {
                        if (row.ieltsExamParticipantsStatusId == "7f616320-e394-4e8d-8013-453f238f7afd") { //true
                            return '<a class="btn btn-warning font-weight-bold mr-2"' +
                                'href="/CustomerIeltsExam/IeltsExamParticipantDetail_Load?Id=' + row.id + '" >Detail</a> ';
                        }
                    }
                },
            ],
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_CustomerIeltsExam')) {
        DT_CustomerIeltsExam.init();
    }
});
