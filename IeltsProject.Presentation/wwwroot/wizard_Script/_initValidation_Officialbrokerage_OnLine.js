...
var _initValidation = function () {
	...
	_validations.push(FormValidation.formValidation(
		_formEl,
		{
			fields: {
				...
				'personalInformationDto.IDCardNo': {
					validators: {
						notEmpty: {
							message: 'شماره شناسنامه اجباری می باشد.'
						}
					}
				},
	...
	_validations.push(FormValidation.formValidation(
		...
		{
			fields: {
				'officialbrokerageInformationDto.OfficialbrokerageName': {
					validators: {
						notEmpty: {
						...
						regexp: {
							regexp: /^[\u0600-\u06FF\s]+$/,  //فقط فارسی                //^![a-zA-Z0-9]+$/ , // /^[0-9]+$/,
							message: 'نام کارگزاری باید فارسی باشد'
						}
					}
				},
				'officialbrokerageInformationDto.OfficialbrokerageCode': {
					validators: {
						notEmpty: {
				...
				'officialbrokerageInformationDto.LicenseValidityDatePersian': {
					validators: {
						notEmpty: {
