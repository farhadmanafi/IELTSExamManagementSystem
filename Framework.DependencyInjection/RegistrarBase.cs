...
namespace Framework.DependencyInjection
{
    ...
    {
        private readonly AssemblyLoader assemblyHelper;
        ...
        protected RegistrarBase()
        {
            ...
            assemblyHelper = new AssemblyLoader(schemaName);
        }
        ...
        {
            services.AddDbContext<IDbContext, IeltsDBContext>(options =>
            {
        ...
        {
            //services.AddSingleton<IMapper, Framework.Mapper.Mapper>();
