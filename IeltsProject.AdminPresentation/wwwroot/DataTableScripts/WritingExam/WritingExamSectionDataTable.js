var DT_WritingExamSectionList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_WritingExamSectionList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_WritingExamSectionList').data("url"),
                type: 'POST'
            },
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/IeltsExamWriting/EditWritingExamSection_Load?Id=' + row.id + '" >ویرایش</a> '
                            + '<a class="btn btn-info font-weight-bold mr-2"' +
                            'href="/IeltsExamWriting/WritingExamTopic_Load?Id=' + row.id + '" >مشاهده متن</a>';
                    }
                },
                //{/*Writing*/
                //    "className": "dt-center",
                ...
                //    render: function (data, type, row) {
                //        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                //            'href="/IeltsExamWriting/WritingQuestionBlock_Load?Id=' + row.id + '" >مدیریت بلوک ها</a> ';
                //    }
                //},
            ],
            columnDefs: [{
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_WritingExamSectionList')) {
        DT_WritingExamSectionList.init();
    }
});
