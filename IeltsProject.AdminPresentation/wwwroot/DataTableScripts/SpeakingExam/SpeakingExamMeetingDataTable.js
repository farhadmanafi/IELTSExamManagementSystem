var DT_SpeakingExamMeetingList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_SpeakingExamMeetingList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_SpeakingExamMeetingList').data("url"),
                type: 'POST'
            },
            columns: [
                { "className": "dt-center", "data": "title", "autowidth": true },
                { "className": "dt-center", "data": "meetingDate_Persian", "autowidth": true },
                { "className": "dt-center", "data": "meetingStartTime", "autowidth": true },
                { "className": "dt-center", "data": "meetingEndTime", "autowidth": true },
                {
                    "data": "isActive",
                    "className": "dt-center",
                    "orderable": false,
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/IeltsExamSpeaking/EditSpeakingExamMeeting_Load?Id=' + row.id + '" >ویرایش</a> ';
                    }
                },
            ],
            columnDefs: [{
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_SpeakingExamMeetingList')) {
        DT_SpeakingExamMeetingList.init();
    }
});
