var DT_ReadingExamSectionList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_ReadingExamSectionList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_ReadingExamSectionList').data("url"),
                type: 'POST'
            },
            columns: [
                ...
                { "className": "dt-center", "data": "orderNo", "autowidth": true },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/IeltsExamReading/EditReadingExamSection_Load?Id=' + row.id + '" >ویرایش</a> '
                ...
                {/*Reading*/
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/IeltsExamReading/ReadingQuestionBlock_Load?Id=' + row.id + '" >مدیریت بلوک ها</a> ';
                    }
                },
            ],
            columnDefs: [{
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_ReadingExamSectionList')) {
        DT_ReadingExamSectionList.init();
    }
});
