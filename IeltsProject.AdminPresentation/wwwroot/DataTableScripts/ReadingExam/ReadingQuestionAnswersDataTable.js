var DT_ReadingQuestionAnswersList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_ReadingQuestionAnswersList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_ReadingQuestionAnswersList').data("url"),
                type: 'POST'
            },
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/IeltsExamReading/EditReadingQuestionAnswer_Load?Id=' + row.id + '" >ویرایش</a> ';
                    }
                },
            ],
            columnDefs: [{
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_ReadingQuestionAnswersList')) {
        DT_ReadingQuestionAnswersList.init();
    }
});
