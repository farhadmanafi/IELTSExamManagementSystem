var DT_ReadingExamQuestionBlockList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_ReadingExamQuestionBlockList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_ReadingExamQuestionBlockList').data("url"),
                type: 'POST'
            },
            columns: [
                ...
                { "className": "dt-center", "data": "orderNo", "autowidth": true },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/IeltsExamReading/EditReadingExamQuestionBlock_Load?Id=' + row.id + '" >ویرایش</a> ';
                    }
                },
            ],
            columnDefs: [{
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_ReadingExamQuestionBlockList')) {
        DT_ReadingExamQuestionBlockList.init();
    }
});
