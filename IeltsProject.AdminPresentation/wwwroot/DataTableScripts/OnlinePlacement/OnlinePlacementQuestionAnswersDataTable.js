var DT_OnlinePlacementQuestionAnswersList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_OnlinePlacementQuestionAnswersList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_OnlinePlacementQuestionAnswersList').data("url"),
                type: 'POST'
            },
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/OnlinePlacement/EditOnlinePlacementQuestionAnswer_Load?Id=' + row.id + '" >ویرایش</a> ';
                    }
                },
            ],
            columnDefs: [{
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_OnlinePlacementQuestionAnswersList')) {
        DT_OnlinePlacementQuestionAnswersList.init();
    }
});
