var DT_PlacementExamPriceList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_PlacementExamPriceList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_PlacementExamPriceList').data("url"),
                type: 'POST'
            },
            columns: [
                { "className": "dt-center", "data": "priceAmount", "autowidth": true },
                { "className": "dt-center", "data": "discontentAmount", "autowidth": true },
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_PlacementExamPriceList')) {
        DT_PlacementExamPriceList.init();
    }
});
