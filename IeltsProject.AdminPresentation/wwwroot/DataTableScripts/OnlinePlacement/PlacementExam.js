var DT_IeltsExamPriceList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_IeltsExamPriceList').DataTable({
            responsive: true,
            // Pagination settings
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_IeltsExamPriceList')) {
        DT_IeltsExamPriceList.init();
    }
});
