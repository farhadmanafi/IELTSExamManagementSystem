var DT_IeltsExamList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_IeltsExamList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            columns: [
                ...
                { "className": "dt-center", "data": "activedDate_Persian", "autowidth": true },
                { "className": "dt-center", "data": "deActivedDate_Persian", "autowidth": true },
                {
                    "data": "isActive",
                    "className": "dt-center",
                    "orderable": false,
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/IeltsExam/EditIeltsExam_Load?Id=' + row.id + '" >ویرایش آزمون</a> '                           
                            //+ '<a class="btn btn-success font-weight-bold mr-2"' +
                            //'href="/IeltsExam/IeltsUserScoreList?Id=' + row.id + '" >نتایج</a>';
                    }
                },
                {/*listening*/
                    "className": "dt-center",
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-info font-weight-bold mr-2"' +
                            'href="/IeltsExamListening/IeltsListening_Load?Id=' + row.id + '" >مدیریت Listening</a>';
                    }
                },
                {/*reading*/
                    "className": "dt-center",
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-info font-weight-bold mr-2"' +
                            'href="/IeltsExamReading/IeltsReading_Load?Id=' + row.id + '" >مدیریت Reading</a>';
                    }
                },
                {/*speaking*/
                    "className": "dt-center",
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-info font-weight-bold mr-2"' +
                            'href="/IeltsExamSpeaking/IeltsSpeaking_Load?Id=' + row.id + '" >مدیریت Speaking</a>';
                    }
                },
                {/*writing*/
                    "className": "dt-center",
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-info font-weight-bold mr-2"' +
                            'href="/IeltsExamWriting/IeltsWriting_Load?Id=' + row.id + '" >مدیریت Writing</a>'
                    }
                },
                {/*Pricing*/
                    "className": "dt-center",
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-info font-weight-bold mr-2"' +
                            'href="/IeltsExam/IeltsExamPrice_Load?Id=' + row.id + '" >مدیریت قیمت آزمون</a>'
                    }
                },
            ],
            columnDefs: [{
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_IeltsExamList')) {
        DT_IeltsExamList.init();
    }
});
