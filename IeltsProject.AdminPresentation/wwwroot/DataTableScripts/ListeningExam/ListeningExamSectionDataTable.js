var DT_ListeningExamSectionList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_ListeningExamSectionList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_ListeningExamSectionList').data("url"),
                type: 'POST'
            },
            columns: [
                ...
                { "className": "dt-center", "data": "orderNo", "autowidth": true },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/IeltsExamListening/EditListeningExamSection_Load?Id=' + row.id + '" >ویرایش</a> ';
                    }
                },
                {/*listening*/
                    "className": "dt-center",
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/IeltsExamListening/ListeningQuestionBlock_Load?Id=' + row.id + '" >مدیریت بلوک ها</a> ';
                    }
                },
            ],
            columnDefs: [{
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_ListeningExamSectionList')) {
        DT_ListeningExamSectionList.init();
    }
});
