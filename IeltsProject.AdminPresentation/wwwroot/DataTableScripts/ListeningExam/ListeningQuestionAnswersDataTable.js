var DT_ListeningQuestionAnswersList = function () {
    ...
    var initTable1 = function () {
        // begin first table
        var table = $('#DT_ListeningQuestionAnswersList').DataTable({
            responsive: true,
            // Pagination settings
            ...
            serverSide: true,
            ajax: {
                url: $('#DT_ListeningQuestionAnswersList').data("url"),
                type: 'POST'
            },
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-warning font-weight-bold mr-2"' +
                            'href="/IeltsExamListening/EditListeningQuestionAnswer_Load?Id=' + row.id + '" >ویرایش</a> ';
                    }
                },
            ],
            columnDefs: [{
...
jQuery(document).ready(function () {
    if (!$.fn.DataTable.isDataTable('#DT_ListeningQuestionAnswersList')) {
        DT_ListeningQuestionAnswersList.init();
    }
});
